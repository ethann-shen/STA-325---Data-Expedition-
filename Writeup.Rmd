...
```{r warning = FALSE, message = FALSE, echo = FALSE}
df.m1 <- data.frame(CV.Error.Moment1 = c(0.368, 0.426, 0.407), AIC.Moment1 = c(167, 170, 168))
row.names(df.m1) <- c("Log Linear", "Spline 1", "Spline 2")
df.m1
```
...
```{r warning = FALSE, message = FALSE, echo = FALSE}
df.m2 <- data.frame(CV.Error.Moment2 = c(4.71, 6.00, 4.07), AIC.Moment2 = c(395, 415, 380))
row.names(df.m2) <- c("Log Linear", "Spline 1", "Spline 2")
df.m2
```
...
```{r warning = FALSE, message = FALSE, echo = FALSE}
df.m3 <- data.frame(CV.Error.Moment3 = c(15.7, 18.0, 11.0), AIC.Moment3 = c(498,  516, 474))
row.names(df.m3) <- c("Log Linear", "Spline 1", "Spline 2")
df.m3
```
...
```{r warning = FALSE, message = FALSE, echo = FALSE}
df.m4 <- data.frame(CV.Error.Moment4 = c(30.6, 37.8, 32.1), AIC.Moment4 = c(562, 578, 562))
row.names(df.m4) <- c("Log Linear",  "Spline 1", "Spline 2")
df.m4
```
